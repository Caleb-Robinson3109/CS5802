...
\begin{document}
	...
	\begin{tabular}{ |p{3cm}|p{2cm}|p{2cm}|p{2cm}|p{2cm}| }
		...
		MPI (16 processes) & 1069 & 1044 & 1243 & 1118.66 \\
		MPI (32 processes) & 2234 & 1266 & 1174 & 1558 \\
...
\end{center}
	...
	\begin{center}
		...
		MPI (16 processes) & 4.098 \\
		MPI (32 processes) & 2.943 \\
		CUDA & 1.025 \\
		\hline
	\end{tabular}
\end{center}
	...
	\begin{tabular}{ |p{3cm}|p{2cm}|p{2cm}| }
		...
		MPI (16 processes) & 2.358 & 0.147 \\
		MPI (32 processes) & 0.00115 & 0.0000391 \\
		\hline
	\end{tabular}
\end{center}
	\begin{figure}[H]
	...
	On every trial for every amount of processes for MPI, MPI outperformed the serial program in run time. Even thought for overlay sixteen and thirty-two processes where not efficient and caused a slow down compared to eight processes. For overlay eight processes had the lowest run time, and two processes had the highest efficiency. As processes where added to overlay the efficiency significantly went down. For Gaussian blur we where unable to test sixteen and thirty-two processes, because of complications with the Mill HPC. Despite that With increased processes Gaussian blur showed remarkable speed up, and there was no point where runtime went higher as processes increase. Each number of processes tested for Gaussian blur the efficiencies stayed above 0.9.
